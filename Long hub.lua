local LongHub = Instance.new("ScreenGui")
...
LongHub.Name = "LongHub"
LongHub.Parent = game.CoreGui
LongHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
Setting:Seperator("「 Credits 」")
    Setting:Label("Made By longpros1900#5286 ")
    Setting:Label("Ui Remade By Mai Đình Long.")
...
setclipboard("https://discord.gg/yF4R4C8Q3Y")
      end)
...
Update:Notification("Hello, "  ..game.Players.LocalPlayer.DisplayName.. " Welcome LongHub V2! What's new? | [+] New Ui [+] New Functions [+] Fix Some Bugs [+] Optimise Script [+] Much More... ")
